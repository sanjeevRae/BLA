...
export default function App() {
  ...
  return (
    <div className="flex h-full flex-col bg-slate-100">
      ...
      <main className="grid flex-1 grid-cols-1 gap-4 overflow-hidden px-4 pb-4 xl:grid-cols-[20rem_1fr_22rem]">
        ...
        <section className="overflow-y-auto rounded-lg bg-white shadow">
          <div className="border-b border-slate-100 p-3">
            <h2 className="text-sm font-semibold text-slate-700">Admin order management</h2>
          </div>

          <form onSubmit={submitOrder} className="space-y-3 border-b border-slate-100 p-4">
